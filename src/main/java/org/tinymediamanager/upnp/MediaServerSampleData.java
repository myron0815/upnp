...
public class MediaServerSampleData {
  ...
  public static LocalService readService(Class<?> serviceClass) throws Exception {
    ...
    service.setManager(new DefaultServiceManager(service, serviceClass));
    return service;
  }

  public static LocalDevice createDevice(Class<?> serviceClass) throws Exception {
    return new LocalDevice(new DeviceIdentity(new UDN("1111")), new UDADeviceType("MediaServer"), new DeviceDetails("My MediaServer"),
